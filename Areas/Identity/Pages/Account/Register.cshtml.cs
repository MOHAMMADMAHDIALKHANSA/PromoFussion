                ...
                if (result.Succeeded)
                {
                    ...
                    switch (Input.Role)
                    {
                        ...
                        default:
                            ...
                            var customer=new Customer { FirstName=Input.Name,Email=Input.Email  };
